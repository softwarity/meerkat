...
var messages = map[string]map[string]string{
	"en": {
		...
		"errSignInUnavailable": "This sign-in method is unavailable right now.",
		"noWayIn":              "Signing in is not available. Please contact your administrator.",
		"errSignInExpired":     "The sign-in attempt expired: please start again.",
		"errNotInvited":        "Your identity is known, but no account here has been opened for you yet.",
		...
		"devCertDesc":           "Register your public certificate so plugged services authenticate with it.",
		"devCertSet":            "Set",
		...
		"devApi":                "API documentation",
		"devApiDesc":            "Explore and try the routes' APIs, as any profile you choose.",
	...
	"fr": {
		...
		"errSignInUnavailable": "Cette méthode de connexion est indisponible pour l'instant.",
		"noWayIn":              "La connexion n'est pas disponible. Contactez votre administrateur.",
		"errSignInExpired":     "La tentative de connexion a expiré : recommencez.",
		"errNotInvited":        "Votre identité est connue, mais aucun compte n'a encore été ouvert pour vous ici.",
		...
		"devCertDesc":           "Enregistrez votre certificat public pour que vos services branchés s'authentifient avec.",
		"devCertSet":            "Défini",
		...
		"devApi":                "Documentation des API",
		"devApiDesc":            "Explorez et essayez les API des routes, en incarnant le profil de votre choix.",
